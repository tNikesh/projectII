...
<div class="container py-0 w-full flex justify-center items-center px-10 gap-x-4 ">
    ...
    <div class="relative w-full flex flex-col justify-start items-start gap-y-1">
        ...
        <div class=" w-3/4  flex justify-evenly items-center   border-2 border-gray-400 md:ml-0"> 
            <button class="flex-1 px-1 text-2xl border-r-2 border-gray-400 mx-auto" type="button" wire:click.prevent.debounce.500ms="increment({{ $cartItem->id }},false)">-</button>
            ...
            <button class="flex-1 px-1 text-2xl border-l-2 border-gray-400" type="button" wire:click.prevent.debounce.500ms="increment({{ $cartItem->id }},true)">+</button>
        </div>
        <div class="">
